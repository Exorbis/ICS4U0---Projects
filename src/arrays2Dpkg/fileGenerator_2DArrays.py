...
def genMagicSquare(size): 
  ...
  f = open("C:\\Users\Marc\Downloads\magicSquares.txt", "a")
...
def MAIN():
  f = open("C:\\Users\Marc\Downloads\magicSquares.txt", "w")
  ...
  f.writelines("*")
  f.close()
  textValue.set("Done! C:\\Users\Marc\Downloads\magicSquares.txt file created!")
