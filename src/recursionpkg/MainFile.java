...
public class MainFile {
	...
	final static String [] PALINDROME_WORD_BANK = {"hello", "racecar", "noon", "birthday","tetraCecarteT", "oo", "it", "a", "oAAAAaao"};
	...
	public static void main(String[] args) {
		...
		System.out.println("\n------------------Palindrome---------------------");
		for (int i = 0; i < PALINDROME_WORD_BANK.length; i ++) {
			if (pal.calculate(PALINDROME_WORD_BANK[i]) == 1) {System.out.println("Non-recursive function for Palindrome of i is: True");}
			else {System.out.println("Non-recursive function for Palindrome of i is: False");}

			if (pal.recursiveCalculate(PALINDROME_WORD_BANK[i]) == 1) {System.out.println("Recursive version is: True");}
			else {System.out.println("Recursive version is: False");}
		}
